...
const (
	...
	ModeDocs  Mode = "docs"
	ModeAsk   Mode = "ask"
	// ModeDebug is a debugging persona: full tool access (like agent) with a
	// methodology-driven system prompt that hypothesizes, narrows, and confirms
	// a diagnosis before applying fixes.
