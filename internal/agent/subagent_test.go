...
func TestPermissionRelayRoutesToTheBrokerOnceTheTurnEnded(t *testing.T) {
	...
	req := seen[0]
	if req.ChildSessionID != "sub_detached" || req.TaskID != "bg_7" || req.AgentName != "writer" {
	...
	if req.Params.SessionID != "sub_detached" {
