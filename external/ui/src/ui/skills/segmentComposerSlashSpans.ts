...
const LEGACY_SKILL_LINK = /\[\/([a-zA-Z0-9][a-zA-Z0-9_-]*)\]\(coddy-skill:([a-zA-Z0-9][a-zA-Z0-9_-]*)\)/g;
...
export function segmentComposerSlashSpans(value: string): ComposerSlashSegment[] {
