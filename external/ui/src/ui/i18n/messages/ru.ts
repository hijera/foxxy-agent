...
export const messagesRu: Record<string, string> = {
  ...
  "settings.mcp.discovery.desc.end":
    "принадлежат вам и через гейт не проходят.",
  ...
  "scheduler.confirmDeleteBody":
    "Задача и её расписание будут удалены навсегда.",
  ...
  "app.confirmDeleteChatBody":
    "Чат и всё его содержимое будут удалены навсегда.",
  "app.delete": "Удалить",
  "app.chatBusy":
  ...
  "nav.miniappsAriaLabel": "Мини-приложения",
  "miniapps.eyebrow": "Повторяемые процессы",
  "miniapps.title": "Мини-приложения",
  "miniapps.catalogTitle": "Ваши процессы",
  "miniapps.pageDescription":
    "Превратите успешную сессию в проверяемый повторяемый процесс.",
  "miniapps.create": "Создать мини-приложение",
  "miniapps.searchLabel": "Поиск мини-приложений",
  "miniapps.searchPlaceholder": "Поиск по имени, описанию или тегу",
  "miniapps.loading": "Загрузка мини-приложений…",
  "miniapps.emptyTitle": "Мини-приложений пока нет",
  "miniapps.emptyDescription":
    "Завершите сессию с инструментами, затем превратите её в повторяемый процесс.",
  "miniapps.emptyAction": "Создать из этой сессии",
  "miniapps.noDescription": "Нет описания",
  "miniapps.released": "Выпущено",
  "miniapps.draft": "Черновик",
  "miniapps.distillation": "Синтез",
  "miniapps.distillationTitle": "Собрать процесс из этой сессии",
  "miniapps.distillationDescription":
    "FoxxyCode извлекает успешные действия и готовит их к проверке.",
  "miniapps.startingDistillation": "Запуск синтеза…",
  "miniapps.preparing": "Подготовка исходного трейса",
  "miniapps.scenarioTitle": "Выберите сохраняемую задачу",
  "miniapps.scenarioDescription":
    "Подтвердите сценарий и ожидаемый результат до генерации процесса.",
  "miniapps.untitledScenario": "Сценарий без названия",
  "miniapps.noOutcome": "Ожидаемый результат не задан",
  "miniapps.noScenarios": "Кандидаты сценариев не получены.",
  "miniapps.confirmScenario": "Сгенерировать процесс",
  "miniapps.cancel": "Отмена",
  "miniapps.close": "Закрыть",
  "miniapps.saving": "Сохранение…",
  "miniapps.editorEyebrow": "Авторинг",
  "miniapps.revisionLabel": "Ревизия черновика {revision}",
  "miniapps.unsaved": "не сохранено",
  "miniapps.editorSections": "Разделы редактора мини-приложения",
  "miniapps.tab.design": "Процесс",
  "miniapps.tab.permissions": "Проверка",
  "miniapps.tab.evidence": "Исходные данные",
  "miniapps.tab.json": "Исходный JSON",
  "miniapps.metadata": "Метаданные",
  "miniapps.name": "Имя",
  "miniapps.goal": "Цель",
  "miniapps.description": "Описание",
  "miniapps.inputs": "Входные данные",
  "miniapps.inputId": "Идентификатор",
  "miniapps.inputTitle": "Метка",
  "miniapps.inputType": "Тип",
  "miniapps.required": "Обязательно",
  "miniapps.newInput": "Новый параметр",
  "miniapps.addInput": "Добавить параметр",
  "miniapps.removeInput": "Удалить параметр",
  "miniapps.steps": "Шаги",
  "miniapps.stepId": "Идентификатор",
  "miniapps.stepTitle": "Название",
  "miniapps.stepKind": "Вид",
  "miniapps.toolName": "Имя инструмента",
  "miniapps.modelBinding": "Привязка модели",
  "miniapps.newStep": "Новый шаг",
  "miniapps.addStep": "Добавить шаг",
  "miniapps.removeStep": "Удалить шаг",
  "miniapps.successCriteria": "Критерии успеха",
  "miniapps.permissions": "Разрешения",
  "miniapps.tools": "Инструменты (по одному в строке)",
  "miniapps.models": "Модели (по одной в строке)",
  "miniapps.permissionsNote":
    "Выпущенный процесс использует только проверенные возможности.",
  "miniapps.verification": "Проверка и исправления",
  "miniapps.validate": "Проверить черновик",
  "miniapps.sanitize": "Проверить санитизацию",
  "miniapps.running": "Выполняется…",
  "miniapps.repairProposal": "Предложение исправления",
  "miniapps.dismiss": "Отклонить",
  "miniapps.acceptPatch": "Принять исправление",
  "miniapps.patchAccepted": "Исправление принято",
  "miniapps.sourceEvidence": "Исходные данные",
  "miniapps.evidencePrivate":
    "Исходные трейсы остаются приватными и не попадают в экспортируемый JSON.",
  "miniapps.rawJson": "Канонический JSON",
  "miniapps.invalidJson": "Перед сохранением введите корректный JSON-объект.",
  "miniapps.saved": "Черновик сохранён",
  "miniapps.validationComplete": "Проверка завершена",
  "miniapps.sanitizationComplete": "Проверка санитизации завершена",
  "miniapps.saveDraft": "Сохранить черновик",
  "miniapps.releaseReview": "Проверка выпуска",
  "miniapps.releaseDescription":
    "Выпуск неизменяем и использует только текущую проверенную ревизию.",
  "miniapps.releaseNeedsCurrentChecks":
    "Сохраните черновик, проверьте его, выполните санитизацию и успешный тестовый запуск этой ревизии перед выпуском.",
  "miniapps.version": "Версия",
  "miniapps.releaseApproval": "Я проверил результаты валидации и санитизации",
  "miniapps.release": "Выпустить версию",
  ...
  "miniapps.runDescription":
    "Запустите неизменяемую версию с новыми входными данными.",
  "miniapps.testDescription":
    "Повторите неизменённый черновик на исходной фикстуре.",
  "miniapps.noInputs": "У этого процесса нет входных параметров.",
  "miniapps.enabled": "Включено",
  "miniapps.chooseValue": "Выберите значение",
  "miniapps.starting": "Запуск…",
  "miniapps.status.pending": "Ожидает",
  "miniapps.status.queued": "В очереди",
  "miniapps.status.running": "Выполняется",
  "miniapps.status.waiting_for_input": "Ожидает ввода",
  "miniapps.status.waiting_for_confirmation": "Ожидает подтверждения",
  "miniapps.status.succeeded": "Успешно",
  ...
  "miniapps.reject": "Отклонить",
  "miniapps.approve": "Разрешить",
  "miniapps.result": "Результат",
  "miniapps.events": "События запуска",
  "miniapps.stepUpdate": "Обновление шага",
  "miniapps.cancelRun": "Отменить запуск",
  "miniapps.rerun": "Запустить снова",
  "miniapps.runHistory": "История запусков",
  "miniapps.noRuns": "Запусков в этой сессии нет.",
  "miniapps.draftRun": "Тест черновика",
  "miniapps.typeString": "Текст",
  "miniapps.typeSecret": "Секрет",
  "miniapps.typeSelect": "Выбор",
  "miniapps.typeBoolean": "Логический",
  "miniapps.typeDate": "Дата",
  "miniapps.typeNumber": "Число",
  "miniapps.kindTool": "Инструмент",
  "miniapps.kindLlm": "Модель",
  "miniapps.kindAgent": "Агент",
  "miniapps.kindConfirm": "Подтверждение",
  "miniapps.kindBranch": "Ветка",
  "miniapps.kindMiniApp": "Мини-приложение",
  "miniapps.selectTitle": "Выберите мини-приложение",
  "miniapps.selectDescription":
    "Выберите процесс из каталога, чтобы изменить, проверить или запустить его.",
};
