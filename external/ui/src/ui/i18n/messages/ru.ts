...
export const messagesRu: Record<string, string> = {
  ...
  "miniapps.addInput": "Добавить поле",
  "miniapps.removeInput": "Удалить поле {title}",
  "miniapps.newInputTitle": "Новое поле",
  "miniapps.addStep": "Добавить шаг",
  "miniapps.removeStep": "Удалить шаг {title}",
  "miniapps.newStepTitle": "Новый шаг",
  "miniapps.editStep": "Редактирование выбранного шага",
  "miniapps.stepId": "Идентификатор шага",
  "miniapps.stepTitle": "Название шага",
  "miniapps.stepKind": "Тип шага",
  "miniapps.stepJson": "JSON шага",
  "miniapps.applyStepJson": "Применить JSON шага",
  "miniapps.stepRequiredFields": "Для шага обязательны id, kind и title.",
  "miniapps.logicalModel": "Логическая модель",
  "miniapps.logicalModelDescription":
    "Именно эта настроенная модель используется в агентских шагах, LLM-проверках и чате редактора.",
  "miniapps.chooseModel": "Выберите настроенную модель",
  "miniapps.noModels": "Нет настроенных моделей",
  "miniapps.modelSaved": "Модель {model} закреплена за этим черновиком.",
  "miniapps.assistant": "Чат редактора",
  "miniapps.assistantDescription":
    "Попросите выбранную модель добавить, удалить или изменить поля, шаги и JSON.",
  "miniapps.assistantEmpty":
    "Опишите изменение. Ассистент исправит черновик через ограниченный набор инструментов.",
  "miniapps.assistantMessage": "Сообщение чату редактора",
  "miniapps.assistantPlaceholder":
    "Например: добавь обязательный выбор файла и шаг его проверки.",
  "miniapps.operator": "Оператор",
  "miniapps.operations": "Применено операций: {count}",
  "miniapps.send": "Отправить",
  "miniapps.assistantWorking": "Обновляем…",
  "miniapps.assistantUpdated": "Чат редактора обновил и сохранил черновик.",
