...
export const messagesEn: Record<string, string> = {
  "messages.svn.card": "Subversion operation",
  "messages.svn.paths": "Paths",
  "messages.svn.target": "Target",
  "messages.svn.branch": "Branch",
  "messages.svn.source": "Merge source",
  "messages.svn.destination": "Destination folder",
  "messages.svn.revision": "Revision",
  "messages.svn.limit": "Revision limit",
  "messages.svn.recursive": "Recursive",
  "messages.svn.accept": "Resolution",
  "messages.svn.message": "Commit message",
  "messages.svn.url": "URL",
  "messages.svn.repositoryRoot": "Repository root",
  "messages.svn.workingCopyRoot": "Working copy root",
  "messages.svn.note": "Note",
  "messages.svn.branches": "Branches",
  "messages.svn.yes": "Yes",
  "messages.svn.no": "No",
  "messages.svn.failed": "Operation failed",
  "messages.svn.cancelled": "Cancelled",
  "messages.svn.waiting": "Awaiting permission",
  "messages.svn.completed": "Completed",
  "messages.svn.running": "In progress",
  "messages.svn.wholeCopy": "Entire working copy",
  "messages.svn.arguments": "Arguments",
  "messages.svn.output": "SVN output",
  "messages.svn.errorOutput": "SVN error",
  "messages.svn.truncated": "Partial output · load more to see the full result",
  "messages.svn.modified": "Modified",
  "messages.svn.added": "Added",
  "messages.svn.deleted": "Deleted",
  "messages.svn.conflicted": "Conflict",
  "messages.svn.unversioned": "Unversioned",
  "messages.svn.missing": "Missing",
  "messages.svn.replaced": "Replaced",
  "messages.svn.ignored": "Ignored",
  "messages.svn.external": "External",
  "messages.svn.obstructed": "Obstructed",
  "messages.svn.clean": "Working copy is clean",
  "messages.svn.operation.info": "SVN · Working copy info",
  "messages.svn.operation.status": "SVN · Working copy status",
  "messages.svn.operation.diff": "SVN · Review changes",
  "messages.svn.operation.log": "SVN · Revision history",
  "messages.svn.operation.list": "SVN · Repository entries",
  "messages.svn.operation.add": "SVN · Add files",
  "messages.svn.operation.revert": "SVN · Revert changes",
  "messages.svn.operation.resolve": "SVN · Resolve conflicts",
  "messages.svn.operation.update": "SVN · Update working copy",
  "messages.svn.operation.commit": "SVN · Commit changes",
  ...
  "settings.sectionDesc.hooks": "Lifecycle hooks & trust",
  "nav.swarm": "Swarm",
  "swarm.title": "Swarm",
  ...
  "usage.keyRejected":
    "The {provider} key was rejected: sign in again (Settings, or foxxycode providers login {provider})",
  ...
  "spawnAgent.cardAriaLabel": "Agent details",
  "spawnAgent.promptAriaLabel": "Agent prompt",
  "spawnAgent.timeout": "Timeout {seconds}s",
  "spawnAgent.timeoutTitle": "Maximum agent execution time",
  ...
  "settings.subagents.legend": "Definitions",
  "settings.subagents.desc.start": "Definitions found in this workspace's",
  "settings.subagents.desc.and": "and",
  "settings.subagents.desc.end":
    "travel with the checkout, so under \"ask\" each one is approved here once for this workspace; rewriting an approved file asks again. Your own files under the FoxxyCode home are never gated.",
  "settings.subagents.policyAppliesAfterSave":
    "The policy above applies once you save; approving a single definition takes effect at once.",
  "settings.subagents.workspace": "Approvals are recorded for",
  "settings.subagents.loading": "Loading definitions…",
  "settings.subagents.empty": "No subagent definitions are visible from this workspace.",
  "settings.subagents.error.load": "Could not load the subagent catalog.",
  "settings.subagents.pendingHint.one": "{count} definition is waiting for your approval.",
  "settings.subagents.pendingHint.other": "{count} definitions are waiting for your approval.",
  "settings.subagents.descriptionWithheld":
    "Description withheld until you approve this file.",
  "settings.subagents.scope.builtin": "built in",
  "settings.subagents.scope.user": "yours",
  "settings.subagents.scope.project": "from the project",
  "settings.subagents.badge.hidden": "hidden",
  "settings.subagents.badge.needsApproval": "needs approval",
  "settings.subagents.trust.approveTitle": 'Approve spawning "{name}" in this workspace',
  "settings.subagents.trust.approvedTitle": "Approved for this workspace (digest {digest})",
  "settings.subagents.trust.approveAria": "Approve subagent {name}",
  "settings.subagents.trust.withdrawAria": "Withdraw approval of subagent {name}",
  "settings.subagents.trust.note.declaredBy": "Declared by",
  "settings.subagents.trust.note.travels":
    ", which travels with the checkout. Approving binds to the file as it stands now:",
  "settings.subagents.trust.note.upperBound":
    "This is an upper bound: a child is also narrowed to what the session spawning it may do, and can never ask you questions, edit the configuration or exit plan mode.",
  "settings.subagents.fact.model": "model",
  "settings.subagents.fact.modelInherits": "the parent's model",
  "settings.subagents.fact.mode": "mode",
  "settings.subagents.fact.modeInherits": "the parent's mode",
  "settings.subagents.fact.permissions": "permissions",
  "settings.subagents.fact.permissionsInherits": "inherited, never wider than the parent",
  "settings.subagents.fact.tools": "tools",
  "settings.subagents.fact.toolsAll": "everything the spawning session can call",
  "settings.subagents.fact.denies": "denies",
  "settings.subagents.fact.timeout": "timeout",
  "settings.subagents.fact.timeoutDefault": "the configured default",
  "settings.subagents.fact.maxTurns": "max turns",
  "settings.subagents.fact.inherits": "inherited",
  "settings.subagents.fact.background": "runs detached",
  "settings.subagents.fact.backgroundAlways": "always, without waiting",
  "settings.subagents.fact.role": "instructions",
  "settings.subagents.fact.digest": "digest",
  ...
  "messages.browser.navigate": "Open page",
  "messages.browser.evaluate": "Execute code",
  "messages.browser.screenshot": "Take screenshot",
  "messages.browser.screenshot_done": "Screenshot taken",
  "messages.browser.click": "Click element",
  "messages.browser.fill": "Fill field",
  "messages.browser.hover": "Hover over element",
  "messages.browser.scroll": "Scroll page",
  "messages.browser.scroll_to": "Scroll to element",
  "messages.browser.read_page": "Read page",
  "messages.browser.page_log": "Page log",
  "messages.browser.inspect": "Inspect page",
  "messages.browser.inspect_storage": "Inspect storage",
  "messages.browser.inspect_timing": "Inspect page load",
  "messages.browser.inspect_memory": "Inspect memory",
  "messages.browser.close": "Close browser",
  "messages.browser.closed": "Browser closed",
  "messages.browser.javascript": "JavaScript",
  "messages.browser.selector": "Element selector",
  "messages.browser.inputText": "Input text",
  "messages.browser.arguments": "Arguments",
  "messages.browser.property": "Property",
  "messages.browser.value": "Value",
  "messages.browser.error": "Error",
  "messages.browser.imageUnavailable": "Screenshot unavailable",
  "messages.browser.screenshotsDisabled": "Screenshots disabled",
  "messages.browser.noOffset": "No displacement",
