...
export const messagesEn: Record<string, string> = {
  ...
  "composer.reasoningLevelNone": "None",
  "composer.reasoningLevelMinimal": "Minimal",
  "composer.reasoningLevelLow": "Low",
  "composer.reasoningLevelMedium": "Medium",
  "composer.reasoningLevelHigh": "High",
  "composer.reasoningLevelXhigh": "Extra high",
  "composer.reasoningLevelMax": "Max",
  ...
  // entry (an MCP server's own tools, the browser and SVN tools with labels of their
  // own) keeps its raw id.
  ...
  "tool.name.docs_write": "writing documentation",
  "tool.name.docs_edit": "editing documentation",
  ...
  "tool.name.foxxycode_todo_plan_replace": "updating the plan",
  "tool.name.foxxycode_todo_plan_read": "reading the plan",
  "tool.name.foxxycode_todo_plan_archive": "archiving the plan",
  "tool.name.foxxycode_todo_item_add": "adding a plan item",
  "tool.name.foxxycode_todo_item_update": "updating a plan item",
  "tool.name.foxxycode_todo_item_remove": "removing a plan item",
  "tool.name.foxxycode_todo_item_move": "moving a plan item",
  ...
  "tool.name.foxxycode_memory_save": "saving a note",
  "tool.name.foxxycode_memory_read": "reading a note",
  "tool.name.foxxycode_memory_list": "listing notes",
  "tool.name.foxxycode_memory_search": "searching notes",
  "tool.name.foxxycode_memory_delete": "deleting a note",
  "tool.name.foxxycode_memory_mkdir": "creating a notes folder",
  "tool.name.foxxycode_scheduler_jobs_list": "listing scheduled jobs",
  "tool.name.foxxycode_scheduler_job_create": "creating a scheduled job",
  "tool.name.foxxycode_scheduler_job_get": "reading a scheduled job",
  "tool.name.foxxycode_scheduler_job_patch": "editing a scheduled job",
  "tool.name.foxxycode_scheduler_job_replace": "replacing a scheduled job",
  "tool.name.foxxycode_scheduler_job_delete": "deleting a scheduled job",
  "tool.name.foxxycode_scheduler_job_pause": "pausing a scheduled job",
  "tool.name.foxxycode_scheduler_job_resume": "resuming a scheduled job",
  "tool.name.foxxycode_scheduler_job_cancel": "cancelling a scheduled job",
  "tool.name.foxxycode_scheduler_job_run": "running a scheduled job",
  "tool.name.foxxycode_scheduler_job_runs": "reading job runs",
  ...
  "prompts.permissionMeta.page": "page {page}",
  ...
  "prompts.permissionMeta.site": "site {site}",
