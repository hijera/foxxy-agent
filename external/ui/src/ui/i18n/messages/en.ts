...
export const messagesEn: Record<string, string> = {
  ...
  "miniapps.removeInput": "Remove input {title}",
  "miniapps.newInputTitle": "New input",
  "miniapps.addStep": "Add step",
  "miniapps.removeStep": "Remove step {title}",
  "miniapps.newStepTitle": "New step",
  "miniapps.editStep": "Edit selected step",
  "miniapps.stepId": "Step id",
  "miniapps.stepTitle": "Step title",
  "miniapps.stepKind": "Step kind",
  "miniapps.stepJson": "Step JSON",
  "miniapps.applyStepJson": "Apply step JSON",
  "miniapps.stepRequiredFields": "A step requires id, kind, and title.",
  "miniapps.logicalModel": "Logical model",
  "miniapps.logicalModelDescription":
    "This exact configured model is used by agent steps, LLM checks, and the authoring assistant.",
  "miniapps.chooseModel": "Choose a configured model",
  "miniapps.noModels": "No configured models",
  "miniapps.modelSaved": "Model {model} is fixed for this draft.",
  "miniapps.assistant": "Authoring assistant",
  "miniapps.assistantDescription":
    "Ask the selected model to add, remove, or rewrite fields, steps, and JSON.",
  "miniapps.assistantEmpty":
    "Describe a change. The assistant will edit the draft through bounded tools.",
  "miniapps.assistantMessage": "Authoring assistant message",
  "miniapps.assistantPlaceholder":
    "For example: add a required file input and a validation step.",
  "miniapps.operator": "Operator",
  "miniapps.operations": "Applied operations ({count})",
  "miniapps.send": "Send",
  "miniapps.assistantWorking": "Updating…",
  "miniapps.assistantUpdated":
    "The authoring assistant updated and saved the draft.",
